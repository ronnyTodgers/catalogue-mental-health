<div class="container-home">
	...
	<div class="homeRow">
		...
		<div class="homeRow odd2" style="padding:1rem">
			<div class="d-md-flex align-items-top justify-content-between">
				<div class="homeInfoBox col-lg-6 d-flex flex-column align-items-top justify-content-around">
					<h4 id="Explore" style="color:white;font-weight:800;" class="text-left h4 mb-2">COVID-19 and the Catalogue of Mental Health Measures</h4>
						<p class="text-left" style="color:white">Browse our COVID timeline for detailed information about the mental health data collected by UK cohort studies during the pandemic</p>
						<a href="?content=4" style="font-size:x-large;padding:1rem;max-width:15rem;margin: 0 auto;" class="btn btn-primary btn-invert">Learn More</a>
				</div>
				<div class="homeInfoBox col-lg-6">
					<img class="covidImage" src="img/COVIDimage.jpg" />
				</div>
			</div>
		</div>
		<div class="homeRow odd">
			<h4 id="Explore" class="h4 mb-2 text-green-800 text-center">Explore the Catalogue of Mental Health Measures</h4>
			<div class="d-md-flex align-items-top justify-content-between">
				<div class="homeInfoBox col-lg-6 d-flex flex-column align-items-top justify-content-around">
					<div class="d-flex align-items-center mb-1 mt-1">
						<i class="homeClipArt far fa-clipboard"></i>
						<p class="mb-0 text-left">Over 45 longitudinal studies -
