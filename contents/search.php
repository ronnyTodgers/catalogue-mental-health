    ...
    <div class="row mb-4 d-none">
     ...
     <div class="row">
             ...
             <div class="card mb-4">
                    <div class="card-header py-3">
                        ...
                        <span class="custom-control custom-switch" id="filtersToggleSpan" style="float: right;">
                         <input type="checkbox" checked="checked" class="custom-control-input" id="filtersToggle" onchange="$(this).siblings('label').attr('title',$(this).prop('checked')?'Filters are active, click to disable':'Filters currently disabled, click to enable'); updateFilters(); ">
                                <label class="custom-control-label" for = "filtersToggle">  </label>
                                <i title="Clear all filters" onclick = "clearFilters();" id="clearFilters" style="color:red; border:red solid 1px;padding:2px;" class="fas fa-times"></i>
                        </span>
                    </h6>
                    </div>
                    <div class="card filterCard mb-0">
                        <!-- Card Header - Accordion -->
                        <a href="#relatedThemesFilter" class="d-block card-header py-3 collapsed" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                        ...
                        <div class="collapse" id="relatedThemesFilter">
                            <div class="card-body">
                                <div class="custom-control custom-switch mb-2 font-weight-bold font-style-italic">
                                    <input type="checkbox" checked="checked" class="andOr toggleFilter custom-control-input" id="relatedAndOr" onchange="$(this).siblings('label').text($(this).prop('checked')?'All the selected filters':'Any of the selected filters'); ">
                     ...
                     <div class="card filterCard mb-0">
                        <!-- Card Header - Accordion -->
                        <a href="#complementaryDataFilter" class="d-block card-header py-3 collapsed" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                        ...
                        <div class="collapse" id="complementaryDataFilter">
                            <div class="card-body">
                                <div class="custom-control custom-switch mb-2 font-weight-bold font-style-italic">
                                    <input type="checkbox" checked="checked" class="andOr toggleFilter custom-control-input" id="cdAndOr" onchange="$(this).siblings('label').text($(this).prop('checked')?'All the selected filters':'Any of the selected filters'); ">
                    ...
                    <div class="card filterCard mb-0">
                        <!-- Card Header - Accordion -->
                        <a href="#studyDesignFilter" class="d-block card-header py-3 collapsed" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                        ...
                        <div class="collapse" id="studyDesignFilter">
                            <div class="card-body">
                                <div class="custom-control custom-switch mb-2 font-weight-bold font-style-italic">
                                    <input type="checkbox" checked="checked" class="andOr toggleFilter custom-control-input" id="sdAndOr" onchange="$(this).siblings('label').text($(this).prop('checked')?'All the selected filters':'Any of the selected filters'); ">
                    ...
                    <div class="card filterCard mb-0">
                        <!-- Card Header - Accordion -->
                        <a href="#sampleCharacteristicsFilter" class="d-block card-header py-3 collapsed" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                        ...
                        <div class="collapse" id="sampleCharacteristicsFilter">
                            <div class="card-body">
                                <div class="custom-control custom-switch mb-2 font-weight-bold font-style-italic">
                                    <input type="checkbox" checked="checked" class="andOr toggleFilter custom-control-input" id="scAndOr" onchange="$(this).siblings('label').text($(this).prop('checked')?'All the selected filters':'Any of the selected filters'); ">
                    ...
                    <div class="card filterCard mb-0">
                        <a href="#ageRangeFilter" class="d-block card-header py-3 collapsed" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                     ...
                     <div class="card filterCard mb-0">
                        <a href="#sizeRangeFilter" class="d-block card-header py-3 collapsed" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                          <h6 class="m-0 text-primary">Sample size</h6>
                        </a>
                        <!-- Card Content - Collapse -->
                        <div class="collapse" id="sizeRangeFilter" style="">
                            <div class="card-body filterSlider">
                     ...
                     <div class="card filterCard mb-0">
                        <!-- Card Header - Accordion -->
                        <a href="#geographicCoverageFilter" class="d-block card-header py-3 collapsed" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                        ...
                        <div class="collapse" id="geographicCoverageFilter">
                            <div class="card-body">
                                <div class="custom-control custom-switch mb-2 font-weight-bold font-style-italic">
                                    <input type="checkbox" checked="checked" class="andOr toggleFilter custom-control-input" id="gcAndOr" onchange="$(this).siblings('label').text($(this).prop('checked')?'All the selected filters':'Any of the selected filters'); ">
                    ...
                    <div class="card filterCard mb-0">
                        <a href="#dateRangeFilter" class="d-block card-header py-3 collapsed" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                          <h6 class="m-0 text-primary">Start date</h6>
                        </a>
                        <!-- Card Content - Collapse -->
                        <div class="collapse" id="dateRangeFilter" style="">
                            <div class="card-body filterSlider">
         ...
         <div class="col-md-8 col-lg-9">
             <div class="card">
                 <div id="studyList" class="card-body"><p>No results, please try a different search term or remove some filters.</p></div>
             </div>
         </div>
