...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a id="MHMjumpLink" href="#timeline" class="d-sm-inline-block btn btn-primary">Jump to study timeline <i
                ...
                <div id="timeline" class="card-header py-3">
                    ...
                    <div id="lineContGroup" class="lineCont">
                        <div id="groupLine" class="line">
                            <svg height="107px" width="100%" id="timeline-ranges"
                                style="stroke:#b1e5a8;stroke-width:1.5">
                    ...
                    <div id="lineCont" class="lineCont">
                        ...
                        <div class="mt-2">
                            <p id="sweepTitle" class="sweepTitle text-primary"><b>Sweep name: </b><span
                                    class="sweepTitleText"></span></p>
                            <p id="sweepCMage" class="sweepTitle text-primary"><b>Cohort member age: </b><span
                                    class="sweepTitleText"></span></p>
                            <p id="sweepDates" class="sweepTitle text-primary"><b>Data collection period: </b><span
                                    class="sweepTitleText"></span></p>
                            <p id="sweepComment" class="sweepTitle text-primary text-truncate"><b>Notes: </b><span
                                    class="sweepTitleText"></span></p>
                            <p id="sweepPhysHealth" class="sweepTitle text-primary text-truncate"><i
                                    class="fas fa-medkit"></i> <b>Physical health measures: </b><span
                                    class="sweepTitleText"></span></p>
                            <p id="sweepTitleSuffix" class="sweepTitle text-primary"><span></span></p>
                        </div>
                    </div>
                </div>
                <table id="dataTable" width="100%" style="width:100%" class="display compact"></table>
            </div>
        </div>
    </div>
</div>
