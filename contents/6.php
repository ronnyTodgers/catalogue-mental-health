...
<div class="card faq ">
	...
	<div class="collapse" id="faq1">
		<div class="card-body">
            <div class="card faq ">
                <a href="#faq1-1" class="d-block card-header py-3 collapsed" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseCardExample">
                    <h6 class="m-0 text-primary">
                    Anxiety
                    </h6>
                </a>
            ...
            <div class="card faq ">
                <a href="#faq1-2" class="d-block card-header py-3 collapsed" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseCardExample">
                    <h6 class="m-0 text-primary">
                    Depression
                    </h6>
                </a>
                <div class="collapse card-body" id="faq1-2">
                    ...
                    <p>For diagnosis, a total of five symptoms should be present, made up from one or both main symptoms accompanied by additional symptoms from the following list:</p>
                    <ul>
                    <li>Significant weight loss or weight gain, or changes in appetite</li>
                    <li>Insomnia or hypersomnia</li>
                    <li>Slowing down or agitation of mental and physical functions</li>
            ...
            <div class="card faq mb-0 ">
                ...
                <div class="collapse card-body" id="faq1-3">
                    ...
                    <li>Disturbance in self-perceived weight or shape, undue influence of body weight or shape on self-evaluation, or denial of the seriousness of the current low body weight</li>
                    </ul>
                    <p>Subtypes:</p>
                    <ul>
		...
		<div class="card-body">
            <div class="card faq mb-0">
                ...
                <div class="collapse card-body" id="faq2-1">
                    ...
                    <li>Easily distracted (including unrelated thoughts)</li>
                    <li>Is forgetful in daily activities</li>
                    <li>Makes careless mistakes/lacks attention to detail</li>
                    <li>Does not seem to listen when spoken to directly</li>
                    <li>Does not follow through on tasks and instructions</li>
                    <li>Exhibits poor organization</li>
                    <li>Avoids/dislikes tasks requiring sustained mental effort</li>
                    <li>Often loses things necessary for tasks/activities</li>
                    </ul>
                    <p>Hyperactive and impulsive symptoms:</p>
                    <ul>
                    <li>Fidgets with or taps hands or feet, squirms in seat</li>
                    <li>Leaves seat in situations when remaining seated is expected</li>
                    <li>Experiences feelings of restlessness</li>
                    <li>Has difficulty engaging in quiet, leisurely activities</li>
                    <li>Is &ldquo;on-the-go&rdquo; or acts as if &ldquo;driven by a motor&rdquo;</li>
                    <li>Talks excessively</li>
                    <li>Blurts out answers</li>
                    <li>Has difficulty waiting their turn</li>
...
<div class="card faq ">
	...
	<div class="collapse" id="faq3">
		<div class="card-body">
            <div class="card faq mb-0">
                <a href="#faq3-1" class="d-block card-header py-3 collapsed" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseCardExample">
                    <h6 class="m-0 text-primary">
                    Psychological wellbeing
                    </h6>
                </a>
                <div class="collapse card-body" id="faq3-1">
...
<div class="card faq ">
	...
	<a href="#faq4" class="d-block card-header py-3 collapsed" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseCardExample">
		<h6 class="m-0 text-primary">
        Treatment, service use and impairment
		</h6>
	</a>
	<!-- Card Content - Collapse -->
	<div class="collapse" id="faq4">
		<div class="card-body">
            <div class="card faq mb-0">
                <a href="#faq4-1" class="d-block card-header py-3 collapsed" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseCardExample">
                    <h6 class="m-0 text-primary">
                    Treatment and service use
                    </h6>
                </a>
                <div class="collapse card-body" id="faq4-1">
                    <p>There are a variety of treatments and services that exist to meet the needs of people living with mental health problems, and their use is often of interest to researchers.</p>
                    <p>Treatments for mental health problems include:</p>
                    <ul>
                    <li>Medication</li>
                    <li>Treatment from a general practitioner</li>
                    <li>Specialist treatment from a psychologist, psychiatrist, therapist, or counsellor</li>
                    <li>Care at an outpatient clinic for mental health</li>
                    <li>Inpatient care, such as in a hospital or rehabilitation centre</li>
                    </ul>
                    <p>Service use includes:</p>
                    <ul>
                    <li>Support at school, such as Special Educational Needs and Disability (SEN/SEND) services</li>
                    <li>Support at home, such as help with activities of daily living</li>
                    <li>Support in achieving personal or occupational goals, such as from a social worker</li>
                    <li>Telephone help line and online resources</li>
                    <li>Community drug and alcohol services</li>
