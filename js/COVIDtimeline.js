...
function selectDate(selector) {
  ...
  $('#timeline .sweepTitle').html("Showing studies that started data collection in: <b>" + sweeps[dates[currentIndex]] + "</b><br><i>click on the timeline to see other timepoints");
