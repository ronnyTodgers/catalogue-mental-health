        ...
        <div id="content">
          ...
          <div class = "navWrapper mb-4">
            <nav class="navbar navbar-expand-lg navbar-light bg-white mb-4 static-top topbar shadow">
              ...
              <a href="?content=home" class="nav-link mr-auto d-lg-inline text-logo-600">Catalogue of<br>Mental Health Measures</a>
...
<a class="scroll-to-top rounded" href="#page-top">
  ...
  <div>This website is using <b>anonymised</b> Google analytics to help us work out how to make it better! <a href="privacy.html">More&nbsp;details</a></div>
</div>
