...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 text-green-800 d-sm-flex align-items-center w-100"><?php print(study_title()); ?></h1>
        <a href="#timeline" class="d-sm-inline-block btn btn-primary">Jump to Mental Health Measures <i class="fas fa-arrow-down"></i></a>
    </div>  
        ...
        <div class="card shadow mb-4">
            <div id="timeline" class="card-header py-3">
                ...
                <div id="lineCont" class = "lineCont"> 
                    ...
                    <p id="sweepComment" class="sweepTitle text-primary" ><b>Notes: </b><span class="sweepTitleText" ></span></p>
