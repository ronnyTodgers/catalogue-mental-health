...
gulp.task('search', () => {
  return gulp
    .src([
      './js/search.js',
      './vendor/search-string/search-string.js'
    ])
    .pipe(stripDebug())
    .pipe(minify({noSource: true}))
...
gulp.task('contents', () => {
  return gulp
    .src([
      './contents/*.*'])
    .pipe(replace('<script src="vendor/search-string/search-string.js" defer></script>', ''))
...
gulp.task('default', gulp.series(['search','contents','index','js','css','copy']));